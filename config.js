...
module.exports = {
    VERSION: 'v1.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/19be8b754c62bdec4236b.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'QUEEN NICKY;Skl11;https://telegra.ph/file/19be8b754c62bdec4236b.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "QUEEN NICKY",
    BOT_NAME: process.env.BOT_NAME || 'QUEEN NICKY',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'QUEEN NICKY;QUEEN NICKY MD BOT;https://telegra.ph/file/19be8b754c62bdec4236b.jpg' : process.env.AUDIO_DATA,
